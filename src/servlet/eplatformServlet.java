...
//        shopInfo transeInfo = new shopInfo();
        try {
            ...
            object1.put("lastName","Bush");
            object1.put("firstName","George");
            JSONObject object2 = new JSONObject();
            Mademd5 md5 = new Mademd5();
            String OIMD = md5.toMd5("something");
            object2.put("OIMD",OIMD);
            String POMD = md5.toMd5(count+OIMD);
            ...
            String DualSignature = encrypt(POMD,privateKey);
            object2.put("DualSignature",DualSignature);
            json.put(object);
            json.put(object1);
            json.put(object2);
